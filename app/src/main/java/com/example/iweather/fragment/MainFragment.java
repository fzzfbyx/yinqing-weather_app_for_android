package com.example.iweather.fragment;
...
import com.example.iweather.Bean.AirBean;
...
import com.example.iweather.adpter.MultipleItemQuickAdapter;
...
import com.example.iweather.util.NetState;
...
public class MainFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if (view == null) {
            ...
            CurrentCityName = MySharedpreference.preferences.getString("City", "西安");
            if (JugeData()) {
                //保存数据是今天则需要取出保存的数据
                getDataFromLocal();
            } else {
    ...
    private void initAirInfo(final int msg) {
        CurrentCityName = MySharedpreference.preferences.getString("City", "西安");//当前城市名
        RestClient.builder()
